...
# # SECRET_KEY = 'django-insecure-l2q*^qpn!3r209_7$vi-bw390*g&h857gn+v!y3$b@tg^-cjlh'
...
# # Tambahkan folder templates global
...
#     BASE_DIR / 'diamond_web' / 'static',  # App-specific static
# ]
...
INSTALLED_APPS = [
    ...
    "crispy_bootstrap5",
    "import_export",
    # ⚠️ LOCAL APP - WAJIB ADA! ⚠️
    'diamond_web',  # ← Tambahkan baris ini jika belum ada!
]
